export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx3922a8fc1ff50de1",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "ac1d6647b7bcfb4799b2d15c494c80e1",
  ...
  USERS: [
    {
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "M_4L9xNHBNkyycUp3DObuX80xYsLyd1hnPn5sHV3yvo",
      // 所在省份
      province: "黑龙江",
      // 所在城市
      city: "大庆",
    ...
    },
   {
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "peR_iG8AydYBqqKTN0ojDzFA-WGxqKFrGz7QhMT_9Ww",
      // 所在省份
      province: "黑龙江",
      // 所在城市
      city: "佳木斯",
